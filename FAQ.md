...
####14、你们事件分析，按小时查看 00:00 的数据表示哪个时间段？  
这个数据指的是从00:00到01:00的数据，其他依此类推。  

####15、链接点击热图中各链接点击百分比加在一起是100%吗，括号里面的数字是什么含义？  
...
####17、数据看板默认推广分析是展现什么？不是默认的在哪儿看？  
答：默认推广分析显示的是浏览页面（次数），不默认的在事件分析查看。  

####18、维度的投放媒体是什么意思？  
答:投放媒体指标识带来流量的网站、广告主、媒体等  

####19、智能路径，转化周期是什么含义？这个分析的意义是什么？  
