...
进入数极客应用后台，点击左侧系统管理，切换到系统管理页面之后点击左侧自定义设置，选择自定义事件，点击右上角添加自定义事件，按要求填写完内容点击保存，如视频所示：  
<video style="width:800px;height:500px"  src="http://www.shujike.com/docsimg/自定义事件.mp4" controls="controls"></video>    
